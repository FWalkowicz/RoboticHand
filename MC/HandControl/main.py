...
if __name__ == "__main__":
    ...
    while True:
        ...
        if len(right_landmarks) != 0:
            ...
            cv2.putText(frame, str(f'y: {right_landmarks[8][2]}'), (150, 80), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 0), 1)
            ...
            cv2.putText(frame, f"Fingers: {finger_counter}", (20, 120), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 0), 1)
